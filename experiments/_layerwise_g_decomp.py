...
if __name__ == '__main__':
    ...
    logger = logging.getLogger('{}_g_decomp'.format(args.layer))
    logging_file = osp.join(log_dir, '{}_g_decomp.log'.format(args.layer))
    ...
    image_path = osp.join(images_dir, '{}_g_decomp.png'.format(args.layer))
