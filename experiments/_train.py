...
from utils import get_mean_std, Config, get_subset_dataset, Config
...
def parse_args():
    ...
    default_workers = 4
    default_model = 'VGG11_bn'
    default_milestone = [10]
    default_step_gamma = 0.1
    default_examples_per_class = 13
    default_epc_seed = 0

    dataset_choices = ['CIFAR10', 'CIFAR100', 'MNIST', 'FashionMNIST']
    model_choices = ['VGG11_bn', 'ResNet18', 'DenseNet3_40', 'MobileNet']
    ...
    parser.add_argument('--epc_seed', type=int, default=default_epc_seed, help='epc seed, default={}'.format(default_epc_seed))
...
if __name__ == '__main__':
    ...
    transform = transforms.Compose([transforms.Pad(0),
                                    transforms.ToTensor(),
    ...
    if args.model in ['VGG11_bn', 'ResNet18', 'DenseNet3_40', 'MobileNet']:
