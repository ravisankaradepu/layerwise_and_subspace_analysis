...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='layerwise hessian lb-ub computation for weights only')
...
if __name__ == '__main__':
    ...
    logger = logging.getLogger('layerwise_hessian_w_lb_ub')
    logging_file = osp.join(log_dir, 'layerwise_hessian_w_lb_ub.log')
    ...
    image_path = osp.join(images_dir, 'layerwise_hessian_w_lb_ub.png')
