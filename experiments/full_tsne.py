...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='full tsne decomposition')
...
if __name__ == '__main__':
    ...
    logger = logging.getLogger('full_tsne')
    logging_file = osp.join(log_dir, 'full_tsne.log')
    ...
    image_path = osp.join(images_dir, 'full_tsne.png')
