...
if __name__ == '__main__':
    ...
    logger = logging.getLogger('full_hessian_decomp')
    logging_file = osp.join(log_dir, 'full_hessian_decomp.log')
    ...
    G = FullHessian(crit='CrossEntropyLoss',
                        loader=loader,
                        device=device,
                        model=model,
                        num_classes=C,
    ...
    image_path = osp.join(images_dir, 'full_hessian_decomp.png')
